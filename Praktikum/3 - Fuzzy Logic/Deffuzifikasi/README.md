# Deffuzifikasi
Ini adalah proses kita mengubah output fuzzy (yang masih bentuknya himpunan fuzzy dengan fungsi keanggotaan pada domain tertentu) menjadi nilai tunggal (crisp).
